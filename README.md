...
Download `T4-Markdown-Viewer_1.0.1_x64-setup.exe` from
...
under Tauri's own name, `T4 Markdown Viewer_1.0.1_x64-setup.exe`.
...
```powershell
Get-FileHash '.\T4-Markdown-Viewer_1.0.1_x64-setup.exe' -Algorithm SHA256
```
